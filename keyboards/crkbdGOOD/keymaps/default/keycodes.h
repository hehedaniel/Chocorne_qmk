...
#define ES_BSLS ALGR(ES_MORD) // (backsl
#define ES_AT   ALGR(KC_2)  // @
#define ES_LBRC ALGR(KC_8)  // [
#define ES_RBRC ALGR(KC_9)  // ]
#define ES_PIPE ALGR(KC_1)  // |
#define ES_HASH ALGR(KC_3)  // #
#define ES_CIRC ALGR(KC_4)  // ^
#define ES_LCBR ALGR(KC_7)  // {
#define ES_RCBR ALGR(KC_0)  // }
